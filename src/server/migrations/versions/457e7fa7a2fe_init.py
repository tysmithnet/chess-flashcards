...
Revision ID: 457e7fa7a2fe
Revises: 
Create Date: 2019-02-25 00:07:32.612661
...
def upgrade():
    ...
    sa.Column('is_stalemate', sa.Boolean(), nullable=True),
    ...
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('start_pos_id', sa.Integer(), nullable=True),
    sa.Column('end_pos_id', sa.Integer(), nullable=True),
